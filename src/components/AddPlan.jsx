...
const AddPlanForm = ({setFormOpen})=>{
    ...
    return (
        <div className="col-span-3 border-2 border-black h-[300px] rounded-md m-4 flex justify-center">
...
const AddPlanButton = ({setFormOpen})=>{
    return (
        <div className="col-span-3 p-auto border-4 border-dashed border-gray-500 h-[300px] rounded-md m-4 flex justify-center">
